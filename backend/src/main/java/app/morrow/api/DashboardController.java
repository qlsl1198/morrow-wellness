...
public class DashboardController {
 ...
 record TimelineResponse(String id,String time,String title,String detail,String kind,boolean userConfirmed){static TimelineResponse from(Timeline t){return new TimelineResponse(t.getId().toString(),t.getTime().toString(),t.getTitle(),t.getDetail(),t.getKind().name(),t.isUserConfirmed());}}
